...
AuthModule = __decorate([
    (0, common_1.Module)({
        imports: [
            ...
            nest_mailman_1.MailmanModule.register({
        ...
        providers: [auth_service_1.AuthService, local_strategy_1.LocalStrategy, jwt_strategy_1.JwtStrategy, venom_service_1.VenomService]
    })
], AuthModule);
